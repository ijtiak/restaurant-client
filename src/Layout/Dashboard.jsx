...
const Dashboard = () => {
    ...
    return (
        <div className="flex">
            <div className="w-64 min-h-screen text-white bg-[#191e24]">
                <ul className="menu p-4">
                    {
                        isAdmin ?
                            <>
                                ...
                                <li><NavLink to="/dashboard/mBookings"><FaBook></FaBook> Manage Bookings</NavLink></li>
                    ...
                    <li><NavLink to="/order/salad"><FaSearch></FaSearch> Order Food</NavLink></li>
